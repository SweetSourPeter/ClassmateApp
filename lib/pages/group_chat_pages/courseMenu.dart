          ...
          SliverList(
            delegate:
              ...
              return FocusedMenuHolder(
                ...
                menuWidth:
                    getRealWidth(MediaQuery.of(context).size.width) * 0.50,
                            ...
                            return AlertDialog(
                              ...
                              actions: <Widget>[
                                TextButton(
                                  child: Text(
                                    'Yes',
                                    style: simpleTextStyle(Colors.black87, 16),
                                  ),
                                  onPressed: () {
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  AutoSizeText(course[index].myCourseName ?? '',
                                      style: GoogleFonts.montserrat(
                                  ...
                                  AutoSizeText(course[index].section ?? '',
                                      style: GoogleFonts.montserrat(
                                          color: Color(0xffFF7E40),
                                          fontSize: 22,
                                          fontWeight: FontWeight.bold)),
                              ...
                              Container(
                                padding: EdgeInsets.only(left: _width * 0.0266),
                                child: AutoSizeText(
