...
class MessageTile extends StatelessWidget {
  ...
  MessageTile(this.message, this.isSendByMe, this.currentTime, this.displayTime, this.displayWeek);
      ...
      children: [
         displayWeek ?
             displayTime ? Container(
               alignment: Alignment.center,
               child: Text(
                 DateFormat('EEEE').format(DateTime.parse(currentTime)) + ',' +
                     currentTime.substring(5, currentTime.length-13),
                 style: GoogleFonts.openSans(
                   fontSize: 10,
